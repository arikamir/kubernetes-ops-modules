...
module "kms_cloudwatch_log_group" {
  ...
  source                      = "github.com/arikamir/kubernetes-ops-modules.git//terraform-modules/aws/kms/cloudwatch_log_group?ref=v2.0.40"
...
module "kms_cloudtrail" {
  ...
  source                      = "github.com/arikamir/kubernetes-ops-modules.git//terraform-modules/aws/kms/cloudtrail?ref=v2.0.40"
